								...
								<nav class="navbar navbar-default gfx-mega nav-left" role="navigation">									
										...
										<div class="collapse navbar-collapse" id="gfx-collapse">
											<ul class="nav navbar-nav gfx-nav">
												...
												<li class="dropdown gfx-mega-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Pages <b class="caret"></b></a>
													<ul class="dropdown-menu">
														<li>
						...
						<div class="row">	
                        	<div class="col-sm-6">
                            	<ul class="list-default fa-ul">
                            		...
                            		<li><span class="fa-li fa fa-envelope color-default"></span>office@avendor.com</li>
                            		<li><span class="fa-li fa fa-clock-o color-default"></span><strong>Monday - Friday:</strong> 09:00 - 18:00</li>                            
                        		</ul>
                            </div>
                        	<div class="col-sm-6">
                            	<ul class="list-default fa-ul">
                        			<li><span class="fa-li fa fa-map-marker color-default"></span>141 Fifth Avenue, 44th Floor New York, United States </li>
                            		<li><span class="fa-li fa fa-envelope color-default"></span>office@avendor.com</li>                         
                        		</ul>
                            </div>
                        </div>
